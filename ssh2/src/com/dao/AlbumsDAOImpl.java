...
public class AlbumsDAOImpl extends HibernateDaoSupport implements IAlbumsDAO {
	private static final Log log = LogFactory.getLog(AlbumsDAOImpl.class);
	// property constants
	...
	public void delete(java.lang.Integer id) {
		log.debug("deleting Album instance");
		try {
			Album album = (Album) getHibernateTemplate().get(
					"com.entity.Album", id);
	...
	public User findByUsername(String name,String pwd)throws IOException{
		log.debug("查询失败！");
		try{
			String hql="from Album t where t.name=:name and t.pwd=:pwd ";
	...
	public static AlbumsDAOImpl getFromApplicationContext(ApplicationContext ctx) {
		return (AlbumsDAOImpl) ctx.getBean("IAlbumsDAO");
	}
}